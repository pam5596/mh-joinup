    ...
    return (
        <Box color="white" bgColor="transparent" fontFamily='ReggaeOne, sans-serif' h="100vh">
            <Flex direction="column" w="full" h="100%">
                <Box rounded="md" bgColor="rgb(2 6 23 / 0.9)" p={{sm: 2, base: 4}} borderColor="#bf730a" borderWidth={4} borderStyle="double">
                    <Heading size="md" color="white" fontFamily='ReggaeOne, sans-serif'>現在の参加者</Heading>
                    <Separator />
                    <Flex direction="column" gap={{sm: 2, base: 4}} mt={4} align="center" h="152px">
                        {liver_info ? 
                            <JoinerItem
                                key={0}
                                is_liver
                ...
                <Box rounded="md" bgColor="rgb(51 65 85 / 0.9)" p={{sm: 2, base: 4}} borderWidth={4} borderColor='rgb(51 65 85)'>
                    ...
                    <Separator />
                    <ScrollArea overflow="hidden" type="always" h="300px" p={2} ref={containerRef}>
